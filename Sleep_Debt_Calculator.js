...
console.log(
    `Function call to 'getActualSleepHours()': ${getActualSleepHours()} actual hours is the output.`,
    "\n"
);
...
console.log(
    `Function call to 'getIdealSleepHours()': ${getIdealSleepHours()} is the ideal number of sleep hours.`,
    "\n"
);
